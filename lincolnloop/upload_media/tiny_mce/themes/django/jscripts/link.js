...
function init() {
	...
	document.getElementById('hrefbrowsercontainer').innerHTML = getBrowserHTML('hrefbrowser','href','file','theme_django_link');
	...
	addClassesToList('styleSelect', 'theme_django_link_styles');
...
function insertLink() {
	...
	tinyMCE.themes['django']._insertLink(href, target, title, dummy, style_class);
	tinyMCEPopup.close();
}
